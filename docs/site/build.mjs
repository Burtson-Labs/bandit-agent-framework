...
.demo-grid { display: flex; flex-wrap: wrap; align-items: flex-start; justify-content: center; gap: 16px; margin: 4px 0 36px; }
.demo { margin: 0; }
.demo img { height: 300px; width: auto; max-width: 100%; border-radius: 10px; border: 1px solid var(--border); box-shadow: 0 18px 48px rgba(0,0,0,0.4); display: block; }
...
@media (max-width: 760px) { .demo img { height: auto; width: 100%; } }
