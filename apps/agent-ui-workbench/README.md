...
## <img src="https://icons.burtson.ai/svg-accent/zap.svg" width="22" align="absmiddle"> Local dev

```bash
pnpm --filter agent-ui-workbench dev
```

## <img src="https://icons.burtson.ai/svg-accent/book-open.svg" width="22" align="absmiddle"> When to use this
