...
export interface ExecutorHooks {
  ...
  postPlanUpdate(stepId: string, state: string, meta?: { summary?: string; durationMs?: number; tokens?: number }): void;
  ...
  autoRevise(goal: string, plan: Plan, results: ExecutionResult[], config: ExecutorAgentConfiguration): Promise<{ results: ExecutionResult[]; iterations: number; retryStepId?: string }>;
